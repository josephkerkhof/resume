    ...
    \resumeSubheading
      ...
      {Web Developer}{May 2016 \textbf{--} Mar 2019}
        \resumeItemListStart
            ...
            \resumeItem{Led a team of 15 Computer Science student developers in design, programming, and standardization of MVC web-based applications using the .NET framework.}
        \resumeItemListEnd
